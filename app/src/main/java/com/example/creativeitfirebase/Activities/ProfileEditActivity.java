    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       currentUserId = intent.getStringExtra("userId");
        ...
        if (firebaseUser!=null){
            ...
            storageReference = FirebaseStorage.getInstance().getReference("P_Upload").child(currentUserId);
        ...
        update_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StorageReference storageRef = storageReference.child("coverPic_"+ name_str + System.currentTimeMillis());
                StorageReference storageRefe = storageReference.child("profilePic_"+ name_str + System.currentTimeMillis());
        ...
        storageRefe.putFile(uri2).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                if (task.isSuccessful()){
                    dialog.dismiss();
